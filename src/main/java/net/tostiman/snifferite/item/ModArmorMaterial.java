...
public class ModArmorMaterial {
	...
	public static final RegistryEntry<ArmorMaterial> SNIFFERITE; 
    ...
    static {
    	SNIFFERITE = register("snifferite", Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
            map.put(ArmorItem.Type.BOOTS, 2);
            map.put(ArmorItem.Type.LEGGINGS, 5);
            map.put(ArmorItem.Type.CHESTPLATE, 6);
            map.put(ArmorItem.Type.HELMET, 2);
            map.put(ArmorItem.Type.BODY, 5);
        }), 12, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0f, 0.0f, () -> Ingredient.ofItems(ModItems.itemSnifferiteIngot));
    }
}
